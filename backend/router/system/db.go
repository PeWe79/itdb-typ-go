...
var databaseBootstrapSQL = []string{
	`CREATE TABLE actions (id INTEGER PRIMARY KEY AUTOINCREMENT,itemid INTEGER, actiondate integer, description, invoiceinfo, isauto)`,
	...
	`CREATE TABLE system_secrets (id INTEGER PRIMARY KEY CHECK (id = 1), jwt_secret TEXT NOT NULL, updated_at INTEGER NOT NULL DEFAULT 0)`,
	`INSERT INTO "itemtypes" ("id", "typeid", "typedesc", "hassoftware") VALUES (1, NULL, '服务器', 1)`,
	`INSERT INTO "itemtypes" ("id", "typeid", "typedesc", "hassoftware") VALUES (2, NULL, '存储', 0)`,
	`INSERT INTO "itemtypes" ("id", "typeid", "typedesc", "hassoftware") VALUES (3, NULL, '交换机', 0)`,
	`INSERT INTO "itemtypes" ("id", "typeid", "typedesc", "hassoftware") VALUES (4, NULL, '电话', 0)`,
	`INSERT INTO "itemtypes" ("id", "typeid", "typedesc", "hassoftware") VALUES (5, NULL, '安防', 0)`,
	...
	`INSERT INTO labelpapers (
		...
		papersize, qrtext, wantnotext, wantraligntext, labelskip
	) VALUES (
...
func EnsureDatabaseInitialized(cfg Config) error {
	...
	if _, err := tx.Exec(`INSERT INTO users (username, userdesc, pass, usertype) VALUES (?, ?, ?, ?)`,
		"admin", "admin", adminPass, 0); err != nil {
		_ = tx.Rollback()
