  ...
  <head>
    ...
    <style>
      :root {
        color-scheme: dark;
        --itdb-text: #e2e8f0;
        --itdb-text-muted: #94a3b8;
        --itdb-border: rgba(76, 103, 150, 0.5);
        --itdb-card: linear-gradient(145deg, rgba(20, 34, 58, 0.96), rgba(8, 15, 29, 0.98));
        --itdb-bg:
      ...
      * { box-sizing: border-box; }
      ...
      p { max-width: 36rem; margin: 0.75rem auto 0; color: var(--itdb-text-muted); }
