      ...
      <DialogContent className="itdb-dialog-panel sm:max-w-md">
        {horizontalHeader ? (
          <DialogHeader className="space-y-0">
            ...
            {detail ? (
              <DialogDescription className="pt-4 leading-6 text-[var(--itdb-text)]">
                {detail}
              </DialogDescription>
            ) : null}
          </DialogHeader>
          ...
          <DialogHeader>
            ...
            {detail ? (
              <DialogDescription className="pt-2 leading-6 text-[var(--itdb-text)]">
                {detail}
              </DialogDescription>
            ) : null}
          </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            className={
              isSuccess
                ? 'itdb-success-soft-button'
                : softDestructive
                  ? 'itdb-danger-soft-button'
                  : confirmClassName
            }
            disabled={busy}
            onClick={onConfirm}
